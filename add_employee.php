...
// $conn=mysqli_connect('localhost','root','','jewelleryshop');
   ...
   $sql1=" SELECT Cid FROM employeedetails WHERE Cid='$Cid'";
  ...
  $sql2 = "INSERT INTO `employeedetails` (`Cid`, `Cname`, `Caddress`, `Cphoneno`) VALUES ('$Cid', '$Cname', '$Caddress', '$Cphoneno')";
   ...
   if(! $retval) {
     ...
     echo "employee Insert";
     echo "<script>alert('employee Inserted!'); location.href='employee.php';</script>";
   }
