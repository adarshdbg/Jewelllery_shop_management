      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="site-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a href="customer.php" class="nav-link">Customer</a></li>
...
<h2 class="navbar-brand">  Check Customer Details :- <input type="text" name="Custid" placeholder="Customer ID"><input type="submit" value="submit"></h2>
</form>
  <table>
  <tr>
    <td>Customer id</td>
