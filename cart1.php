...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		...
		(int)$cartTotal =(int) $cartTotal;
		(int)$producttotalpricetotal = (int)$producttotalprice * (int)$each_item['quantity'];
		(int)$cartTotal = (int)$producttotalpricetotal + (int)$cartTotal;
echo'<tr>
